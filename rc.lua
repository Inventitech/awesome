...
beautiful.init("/home/moritz/.config/awesome/themes/default/theme.lua")
...
-- {{{ network widget
network_wig = status_widget("nettwork_wig", network)
-- }}}

-- {{{ split widget
split_wig = wibox.widget.textbox()
split_wig:set_text(" | ")
-- }}}
...
for s = 1, screen.count() do
    ...
    right_layout:add(network_wig)
    right_layout:add(split_wig)
    right_layout:add(batt_wig)
    right_layout:add(split_wig)
    right_layout:add(volume_wig)
    right_layout:add(split_wig)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86KbdBrightnessUp", brightnessup),
    awful.key({}, "XF86KbdBrightnessDown", brightnessdown),
    -- }}}
